<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GeneralUser.aspx.cs" Inherits="POE_AdvancedWeatherForecastingSystem.GeneralUser" %>
...
<body>
    <form id="form1" runat="server">
          <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <div class="navbar-collapse" id="navbarContent">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="Favourite.aspx">Favourite</a>
                    </li>
                </ul>
        ...
        <div class="container">
            <h1 class="text-center">Weather Update</h1>
